...
class HoloRoomHandRenderer : CorpseDetection
{
    ...
    private GestureResult hand;

    private string hrri;

    private bool shouldRenderHand = true;
    ...
    public void SetHand(GestureResult hand) {
        this.hand = hand;
    }

    void Update()
    {
        shouldRenderHand = IsCorpse();
        ...
        for (int i = 0; i < points.Count; i++)
        {
            ...
            go.SetActive(go.transform.position.IsValidGesturePoint() && shouldRenderHand);
        ...
        for (int i = 0; i < links.Count; i++)
        {
            ...
            link.SetActive(shouldRenderHand);
